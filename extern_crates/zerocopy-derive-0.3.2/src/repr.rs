...
use {
    proc_macro2::Span,
    syn_1::spanned::Spanned,
    syn_1::{Attribute, DeriveInput, Error, Lit, Meta, NestedMeta},
};
...
pub trait KindRepr: 'static + Sized + Ord {
    ...
    fn parse(meta: &NestedMeta) -> syn_1::Result<Self>;
}
...
macro_rules! define_kind_specific_repr {
    ($type_name:expr, $repr_name:ident, $($repr_variant:ident),*) => {
        ...
        impl KindRepr for $repr_name {
            ...
            fn parse(meta: &NestedMeta) -> syn_1::Result<$repr_name> {
